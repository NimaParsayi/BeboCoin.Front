...
export default {
    ...
    methods: {
        ...
        inviteFriend(){
            window.Telegram.WebApp.openTelegramLink(`https://t.me/share/url?url=${BOT_LINK}?start=ref_${this.user.chatId}&text=Build your team to increase your mining rate and earn 500 tickets for a new friend!`);
        }
    }
};
</script>
